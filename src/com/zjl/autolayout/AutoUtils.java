...
public class AutoUtils {
    ...
    public static void auto(Window window) {
        if (window == null || displayWidth < 1 || displayHeight < 1) return;
    ...
    public static void auto(Dialog dialog) {
        if (dialog == null || displayWidth < 1 || displayHeight < 1) return;
    ...
    public static Object getField(Object obj, Class cls, String fields) {
        try {
            Field field = cls.getDeclaredField(fields);
    ...
    public static boolean setField(Object obj, Class cls, String fields, Object value) {
        try {
            Field field = cls.getDeclaredField(fields);
            field.setAccessible(true);
            field.set(obj, value);
    ...
    public static void autoSize(View view) {
        ...
        if (width != null && width > 0) {
            view.setMinimumWidth(getDisplayWidthValue(width));
        }
        Integer height = (Integer) getField(view, View.class, "mMinHeight");
        if (height != null && height > 0) {
            view.setMinimumHeight(getDisplayHeightValue(height));
        }
    }
    ...
    public static void autoTextSize(View view) {
        if (view instanceof TextView) {
            ...
            double displayPixels = designPixels * displayHeight / designHeight;//textPixelsRate * designPixels;
            //((TextView) view).setIncludeFontPadding(false);
            ((TextView) view).setTextSize(TypedValue.COMPLEX_UNIT_PX, (float) displayPixels);

            Float mSpacingMult = (Float) getField(view, TextView.class, "mSpacingMult");
            Float mSpacingAdd = (Float) getField(view, TextView.class, "mSpacingAdd");
            if (mSpacingMult != null && mSpacingAdd != null) {
                ((TextView) view).setLineSpacing(mSpacingAdd * displayHeight / designHeight, mSpacingMult);
            }
        }
    }
